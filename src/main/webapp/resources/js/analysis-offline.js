...
var AnalysisOffline = {
    init: function () {
        ...
        require([
            ...
            var timeline = dataMap.dataTimeline;
            var textStyle = {
                    color: '#eee'
                },
                splitLine = {
            ...
            var genSummaryBar = function (chart) {
                ...
                var successCallback = function (data) {
                    ...
                    basicBarOption.options[0].series[0].data = dataMap.dataGlobal[timeline[0]];
                    basicBarOption.options[0].series[1].data = dataMap.dataChina[timeline[0]];
                    for (var i = 1; i < timeline.length; i++) {
                        var option = {
                            title: {text: timeline[i].replace('-', '年') + '月扫描统计'},
                            series: [
                                {data: dataMap.dataGlobal[timeline[i]]},
                                {data: dataMap.dataChina[timeline[i]]}
                            ]
                        };
