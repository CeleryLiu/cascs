$(function () {
    ...
    $docSideNav.on("click tap", "a", function () {
        $body.animate({scrollTop: $(this.hash).offset().top}, DURATION);
        return false
    });
...
$(function () {
    ...
    var toggleBanner = function () {
        ...
        $pre.toggleClass("on").css({height: $pre.hasClass("on") ? $pre.data("height") : MAX_HEIGHT})
    };
